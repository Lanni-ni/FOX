...
from megatron.model.forgetting_attention import FoXAttention
...
class ParallelSelfAttention(nn.Module):
    ...
    def __init__(
        ...
        if self.attention_type == "fox":
            self.fox_module = FoXAttention(
    ...
    def forward(self, hidden_states, attention_mask, layer_past=None):
        ...
        # =====================
        if self.attention_type == "fox":
            context_layer, _ = self.fox_module(hidden_states, attention_mask, layer_past)
